...
class ContactPersonModel(db.Model):
    ...
    # [GDPR] ACHTUNG: Enthält personenbezogene Daten (PII).
    # Diese Daten werden lokal in shows.db gespeichert.
    # Bei Export oder Weitergabe muss die DSGVO beachtet werden (Datensparsamkeit, Zustimmung).
